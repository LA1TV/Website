...
class PlayerController extends HomeBaseController {
	...
	public function getIndex($playlistId, $mediaItemId) {
		...
		$twitterProperties[] = array("name"=> "player", "content"=> $playlist->getMediaItemEmbedUri($currentMediaItem)."?autoPlayVod=0&autoPlayStream=0&flush=1&showHeading=0&disableFullScreen=1&disableRedirect=1");

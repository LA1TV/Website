...
class CreatingProductionRolesPlaylistTable extends Migration {
	...
	public function up()
	{
		Schema::create('production_roles_playlist', function(Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::drop('production_roles_playlist');
	}

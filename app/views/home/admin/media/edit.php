				...
				<div class="panel-collapse collapse">
					<div class="panel-body">
						...
						<div class="enabled-container">
							...
							<?=FormHelpers::getFormUploadInput(1, "Video", "vod-video-id", $form['vod-video-id'], $formErrors, AllowedFileTypesHelper::getVideos(), $form['vod-video-file-name'], $form['vod-video-file-size']);?>

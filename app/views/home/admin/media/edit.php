<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<?=FormHelpers::getFormUploadInput(1, $sideBannersFillImageUploadPointId, "Side Banners Fill Image (Optional) (Should Be 250x1400)", "side-banners-fill-image-id", $form['side-banners-fill-image-id'], $formErrors, $additionalForm['sideBannersFillImageFile']['name'], $additionalForm['sideBannersFillImageFile']['size'], !$additionalForm['sideBannersFillImageFile']['inUse'], $additionalForm['sideBannersFillImageFile']['processState'], $additionalForm['sideBannersFillImageFile']['processPercentage'], $additionalForm['sideBannersFillImageFile']['processMsg']);?>

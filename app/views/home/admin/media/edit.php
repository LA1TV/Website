<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<?=FormHelpers::getFormUploadInput(1, $coverImageUploadPointId, "Cover Image (Optional)", "cover-image-id", $form['cover-image-id'], $formErrors, AllowedFileTypesHelper::getImages(), $form['cover-image-file-name'], $form['cover-image-file-size']);?>
		<?=FormHelpers::getFormUploadInput(1, $sideBannersImageUploadPointId, "Side Banners Image (Optional)", "side-banners-image-id", $form['side-banners-image-id'], $formErrors, AllowedFileTypesHelper::getImages(), $form['side-banners-image-file-name'], $form['side-banners-image-file-size']);?>
				...
				<div class="panel-collapse collapse <?=$form['vod-added']==="1"?"in":""?>">
					<div class="panel-body">
						...
						<div class="enabled-container">
							...
							<?=FormHelpers::getFormUploadInput(1, $vodVideoUploadPointId, "Video", "vod-video-id", $form['vod-video-id'], $formErrors, AllowedFileTypesHelper::getVideos(), $form['vod-video-file-name'], $form['vod-video-file-size']);?>

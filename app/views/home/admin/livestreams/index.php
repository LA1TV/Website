		...
		<table class="table table-striped table-bordered table-hover">
			...
			<?php foreach($tableData as $a): ?>
				<tr>
					...
					<?php if ($editEnabled): ?>
					<td class="action-col"><a class="btn btn-xs btn-info" href="<?=e($a['playerUri'])?>">Watch</a> <a class="btn btn-xs btn-info" href="<?=e($a['editUri'])?>">Edit</a> <button type="button" class="btn btn-xs btn-danger" data-action="delete" data-deleteuri="<?=e($deleteUri)?>" data-deleteid="<?=e($a['id'])?>">&times;</button></td>
					<?php endif; ?>
				</tr>
			<?php endforeach; ?>
				<?php if ($editEnabled): ?>

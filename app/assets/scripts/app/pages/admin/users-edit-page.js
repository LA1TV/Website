define([
	...
	"lib/domReady!"
], function($, PageData, ToggleableComponent, SelectComponent, ReorderableList, AjaxSelect) {
	...
	$(".page-users-edit").first().each(function() {
		...
		$pageContainer.find(".form-groups").each(function() {
			...
			var reorderableList = new ReorderableList(true, true, true, function(state) {
				var ajaxSelect = new AjaxSelect(PageData.get("baseUrl")+"/admin/permissions/groupsajaxselect", state);
